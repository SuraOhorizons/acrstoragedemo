...
|---|---|---|
| Resource Group | `rg-acrstoragedemo-dev` | Región: `eastus2` |
| Container Registry | `acracrstoragedemodev` | SKU Basic, admin user deshabilitado |
| Storage Account | `stacrstoragedemodev` | Standard/LRS, TLS 1.2 mínimo |
